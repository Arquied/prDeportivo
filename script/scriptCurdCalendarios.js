$(document).ready(function() {
	...
	//EVENTO ONCLICK CONFIRMAR BORRADO REDIRECCIONA PASANDOLE EL ID_CALENDARIOS
	$("#seguroBorrar").on("click", function(){
		window.location="index.php?co=temporadas&ac=borraTemporada&id="+$("#modalBorrado").data("id_calendario");
	});
});
